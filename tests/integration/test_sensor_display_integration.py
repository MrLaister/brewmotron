...
from tests.fixtures.hardware_mocks import (
    MockSMBus, MockTemperatureSensor, Mock7SegmentDisplay, 
...
class TestSensorDisplayIntegration:
    ...
    async def test_sensor_to_7seg_display_flow(self, integration_harness):
        ...
        assert mash_display.display_buffer != [0, 0, 0, 0], "Display should show temperature data"
    ...
    async def test_multiple_sensors_consistent_display(self, integration_harness):
        ...
        assert mash_7seg.display_buffer != [0, 0, 0, 0], "Mash 7-seg display should show data"
        assert boil_7seg.display_buffer != [0, 0, 0, 0], "Boil 7-seg display should show data"
    ...
    async def test_temperature_ramping_display_response(self, integration_harness):
        ...
        for target_temp in temperatures:
            ...
            mash_display = seg_display.displays[0x70]
            assert mash_display.display_buffer != [0, 0, 0, 0], f"Display should show data at {target_temp}°C"
