...
class TestGPIOResourceManagement:
    ...
    async def test_gpio_resource_cleanup(self, gpio_system):
        ...
        for i, plugin in enumerate(plugins):
            ...
            assert resource_manager.get_pin_allocation(pins[i]) is None, \
