...
class BrewingRecipeFactory(Factory):
    ...
    fermentation_schedule = LazyAttribute(
        lambda obj: [
...
class BrewmotronTestData:
    ...
    def get_standard_plugin_configs() -> List[PluginConfig]:
        ...
        return [
            ...
            PluginConfig(
                ...
                name="LCDisplay",
                type="Extension",
                props={"I2C_Address": "0x27", "Cols": 20, "Rows": 4, "Backlight": True},
            ),
            PluginConfig(
                id="mash_temp_sensor",
                name="i2cTempSensor",
            ...
            PluginConfig(
                ...
                name="GPIOInput",
                type="Actor",
                props={"GPIO": 18, "Inverted": "No", "LinkedActor": None},
            ),
            PluginConfig(
                id="heating_element",
                name="AlwaysONGPIO",
                type="Actor",
                props={"GPIO": 19, "Inverted": "No"},
            ),
            PluginConfig(
                id="mode_key",
                name="BMT-Key",
                type="Extension",
                props={"Key_File": "/home/brewmotron/mode.key", "Default_Mode": "brew"},
            ),
            PluginConfig(
                id="momentary_buttons",
                name="BMT-MomentaryButtons",
                type="Actor",
                props={"GPIO": 21, "Inverted": "No", "Bounce_Time": 200},
            ),
            PluginConfig(
                id="internet_gpio",
    ...
    def get_i2c_device_states() -> Dict[int, I2CDeviceConfig]:
        ...
        devices[0x27] = I2CDeviceConfig(
            address=0x27,
            device_type="PCF8574",
            registers={0x00: 0xFF},  # All pins high initially
        )
...
def generate_sensor_readings(
    sensor_id: str, count: int = 100, base_value: float = 20.0, variation: float = 2.0
) -> List[SensorReading]:
...
__all__ = [
    ...
    "ActorStateFactory",
    "BrewingRecipeFactory",
    "I2CDeviceConfigFactory",
    "GPIOPinConfigFactory",
    "BrewmotronTestData",
    "generate_sensor_readings",
    "generate_actor_state_history",
