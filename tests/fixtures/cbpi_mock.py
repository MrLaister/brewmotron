...
class MockCBPiConfig:
    ...
    async def add(self, key: str, value: Any, type: str = "string", 
                  description: str = "", options: Optional[List] = None) -> None:
...
class MockCBPiNotification:
    ...
    async def notify(self, title: str, message: str, type: str = "info", 
...
class PluginTestHarness:
    ...
    async def load_plugin(self, plugin_class, plugin_id: str, 
                         props: Optional[Dict] = None) -> Any:
...
class MockProperty:
    @staticmethod
    def Text(label: str, configurable: bool = True, default_value: str = "", 
            description: str = ""):
        return create_mock_property(label, "Text", 
                                  configurable=configurable,
                                  default_value=default_value,
                                  description=description)
    
    @staticmethod
    def Number(label: str, configurable: bool = True, default_value: float = 0.0,
              description: str = ""):
        return create_mock_property(label, "Number",
                                  configurable=configurable, 
                                  default_value=default_value,
                                  description=description)
    
    @staticmethod
    def Select(label: str, options: List, configurable: bool = True,
              description: str = ""):
        return create_mock_property(label, "Select",
                                  configurable=configurable,
                                  options=options,
                                  description=description)
    ...
    def Actor(label: str, configurable: bool = True, description: str = ""):
        return create_mock_property(label, "Actor",
                                  configurable=configurable,
                                  description=description)
    
    @staticmethod
    def Sensor(label: str, configurable: bool = True, description: str = ""):
        return create_mock_property(label, "Sensor",
                                  configurable=configurable,
                                  description=description)
