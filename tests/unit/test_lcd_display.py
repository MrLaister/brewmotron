...
class TestLCDisplay:
    ...
    async def test_singledisplay_mode_cycling(self, plugin_harness, mock_lcd):
        ...
        plugin = await plugin_harness.load_plugin(MockLCDisplay, config.id, {})
    ...
    async def test_lcd_hardware_communication(
        ...
        plugin = await plugin_harness.load_plugin(MockLCDisplay, display_config.id, {})
...
class TestLCDisplayEdgeCases:
    ...
    async def test_invalid_lcd_address(self, plugin_harness):
        ...
        plugin = await plugin_harness.load_plugin(MockLCDisplay, invalid_config.id, {})
    ...
    async def test_lcd_hardware_failure_recovery(self, plugin_harness):
        ...
        plugin = await plugin_harness.load_plugin(MockLCDisplay, "test_recovery", {})
