            ...
            def get_active_step_values(self):
                ...
                try:
                    if self._scenario == 1:
                        ...
                        mock_steps = [
                            {"status": "I", "props": {"Temp": "60", "Kettle": "kettle1"}},
                            {"status": "A", "props": {"Temp": "75", "Kettle": "kettle2"}},
                            {"status": "P", "props": {"Temp": "80", "Kettle": "kettle3"}}
                        ]
                        ...
                        for step in mock_steps:
                            if step["status"] == "A":
                                ...
                                self.step_detection_calls.append(f"Found active step: {targetTemp}°C, kettle: {kettle_id}")
